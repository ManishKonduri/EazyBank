...
import com.makon.accounts.dto.AccountsDto;
...
import com.makon.accounts.exception.CustomerAlreadyExistsException;
...
public class AccountsServiceImpl implements IAccountsService {
    ...
    public boolean updateAccount(CustomerDto customerDto) {
        ...
        if(accountsDto != null) {
            Accounts accounts = accountsRepository.findById(Long.valueOf(accountsDto.getAccountNumber())).orElseThrow(() -> new ResourceNotFoundException("Account", "AccountNumber", accountsDto.getAccountNumber()));
